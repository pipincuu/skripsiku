...
<div id="page-wrapper">
            ...
            <div class="container-fluid">
  			...
  			<div class="row">
                    ...
                    <select name="nim" class="form-control">
				 			 	<?php foreach($id as $key) { ?>
				 			 		<option value="<?php echo $key->nim ?>"><?php echo $key->nim." - ".$key->nama_mahasiswa ?></option>
				 			 	<?php } ?>
				 			 	</select>
  				 			 </div>
              ...
              <div class="form-group">
                 ...
                 <input class="span2 form-control" name="tanggal_pinjam" size="3" type="text" value="<?php echo date('Y-m-d'); ?>">
              ...
              <div class="form-group">
                 ...
                 <input class="span2 form-control" name="tanggal_kembali" size="3" type="text" value="<?php echo date('Y-m-d'); ?>">
                <!--  <di class="add-on input-group-addon"><i class="fa fa-calendar"></i></span> -->
               </div>
              </div>
